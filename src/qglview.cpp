...
QSize SceneView::sizeHint() const { return QSize(200, 200); }
QSize SceneView::minimumSizeHint() const { return QSize(100, 100); }

bool SceneView::isWireframe() const { return m_wireframe; }
...
bool SceneView::isOrtho() const { return m_ortho; }
...
QColor SceneView::backgroundColor() const { return sceneBackgroundColor; }
...
void SceneView::resetGL() { delete m_scene; }
