...
[Parameters]vec3 LightPosition = vec3(0, 0, 4);
float Shininess = 8;
...
float Xcenter = -0.4;
float Ycenter = 0;
float MaxIterations = 240;
vec3 InnerColor = vec3(0.534, 0.332, 0);
vec3 OuterColor1 = vec3(1, 0.72, 0);
vec3 OuterColor2 = vec3(0, 1, 0.842);
